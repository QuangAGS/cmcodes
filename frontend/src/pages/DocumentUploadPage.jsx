 ...
 * DATETIME   : 2026-09-03T16:20:00+07:00
 * VERSION    : 1.0.0-A01-DOCS
 * DESCRIPTION: Upload tài liệu khác. MIME rộng. Caption bắt buộc.
 */
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-[480px] flex-col bg-slate-50">
      ...
      <div className="px-4 pt-3">
        ...
        <p className="mt-1 text-sm text-slate-500">Nhiều định dạng · mỗi file ≤ 10MB · tổng ≤ 30MB. Bắt buộc mô tả.</p>
      </div>
